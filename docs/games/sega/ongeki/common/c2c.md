...
!!! tip "GAME ASSIGNMENTS"
    ...
    <img class="portrait" src="/two-torial/img/sega/ongeki/common/c2c/service.webp">

    - Make sure all machines are on the same group (Group A for example)
    <img src="/two-torial/img/sega/ongeki/common/c2c/group.webp">

    - Set one machine to `STANDARD`, and all other machines to `FOLLOW THE STANDARD`
    <img src="/two-torial/img/sega/ongeki/common/c2c/standard.webp">
    <img src="/two-torial/img/sega/ongeki/common/c2c/followstandard.webp">
...
!!! Info "If you're new to O.N.G.E.K.I. and have never tried link-play before and you have no idea how, keep reading"
    ...
    <img class="portrait" src="/two-torial/img/sega/ongeki/common/c2c/host.webp">

    - If you're connecting, navigate to the `Cabinet-to-Cabinet Play` tab and wait for other players to create a session
    <img class="portrait" src="/two-torial/img/sega/ongeki/common/c2c/client.webp">
