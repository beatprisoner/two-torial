...
!!! tip ""
    ...
    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/1.webp">
    ...
    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/2.webp">

    Select `CALIBRATION SETTINGS` and press `Start`.

    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/3.webp">
    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/4.webp">
    ...
    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/5.webp">

    Select `SAVE AND EXIT` and press `Start`.

    <img src="/two-torial/img/konami/sdvx/6_exceedgear/calibration/6.webp">
